...
public class UserVantagesLogsDo extends BaseDo {
	...
	public static final String OBJECTKEY ="yjs:t_user_vantages_logs";
	String CREATER;
	String LAST_USER;
	public String getId() {
		return this.id;
	...
	public int getVantagesId() {
		return this.vantagesId;
	}
	public void setVantagesId(int vantagesId) {
		this.vantagesId = vantagesId;
	}
